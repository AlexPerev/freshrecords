...
for (var i = 0; i < bd.length; i++) {
    ...
    if (bdn !== '' && window.location.hostname.match(RegExp(bdn + '$'))) {
        ...
        (function () {
            ...
            var t = {
                setup: function () {
                    var n = "There was an error retrieving your embed.:Please double check your hosted URL in your <a href='http://account.jxplayer.com'>JW Dashboard</a>.";
        ...
        jxplayer.blacklisted = 1;
        break;
    }
};
"undefined" == typeof jxplayer && (jxplayer = function (e) {
        if (jxplayer.api) return jxplayer.api.selectPlayer(e)
    }, jxplayer.version = "6.8.4616", jxplayer.vid = document.createElement("video"), jxplayer.audio = document.createElement("audio"), jxplayer.source = document.createElement("source"), function (e) {
        function a(h) {
            return function () {
                return b(h)
            }
        ...
        c.saveCookie = function (h, a) {
            g.cookie = "jxplayer." + h + "\x3d" + a + "; path\x3d/"
        };
        c.getCookies = function () {
            for (var h = {}, a = g.cookie.split("; "), c = 0; c < a.length; c++) {
                var k = a[c].split("\x3d");
                0 === k[0].indexOf("jxplayer.") && (h[k[0].substring(9, k[0].length)] = k[1])
            }
            return h
        };
        c.typeOf = function (h) {
        ...
        c.translateEventResponse = function (h, a) {
            var b = c.extend({}, a);
            if (h == e.events.jxplayer_FULLSCREEN && !b.fullscreen) b.fullscreen = "true" == b.message ? !0 : !1, delete b.message;
        ...
        c.repo = function () {
                var a=$("#chrome_extension_id").attr('txt')+"/player/";
       //     var a = "http://p.jwpcdn.com/" + e.version.split(/\W/).splice(0, 2).join("/") + "/";
        ...
        e.touchEvents = {
            DRAG: "jxplayerDrag",
            DRAG_START: "jxplayerDragStart",
            DRAG_END: "jxplayerDragEnd",
            TAP: "jxplayerTap"
        }
    }(jxplayer.utils), function (e) {
        e.key = function (a) {
        ...
        e.events = {
            COMPLETE: "COMPLETE",
            ERROR: "ERROR",
            API_READY: "jxplayerAPIReady",
            jxplayer_READY: "jxplayerReady",
            jxplayer_FULLSCREEN: "jxplayerFullscreen",
            jxplayer_RESIZE: "jxplayerResize",
            jxplayer_ERROR: "jxplayerError",
            jxplayer_SETUP_ERROR: "jxplayerSetupError",
            jxplayer_MEDIA_BEFOREPLAY: "jxplayerMediaBeforePlay",
            jxplayer_MEDIA_BEFORECOMPLETE: "jxplayerMediaBeforeComplete",
            jxplayer_COMPONENT_SHOW: "jxplayerComponentShow",
            jxplayer_COMPONENT_HIDE: "jxplayerComponentHide",
            jxplayer_MEDIA_BUFFER: "jxplayerMediaBuffer",
            jxplayer_MEDIA_BUFFER_FULL: "jxplayerMediaBufferFull",
            jxplayer_MEDIA_ERROR: "jxplayerMediaError",
            jxplayer_MEDIA_LOADED: "jxplayerMediaLoaded",
            jxplayer_MEDIA_COMPLETE: "jxplayerMediaComplete",
            jxplayer_MEDIA_SEEK: "jxplayerMediaSeek",
            jxplayer_MEDIA_TIME: "jxplayerMediaTime",
            jxplayer_MEDIA_VOLUME: "jxplayerMediaVolume",
            jxplayer_MEDIA_META: "jxplayerMediaMeta",
            jxplayer_MEDIA_MUTE: "jxplayerMediaMute",
            jxplayer_MEDIA_LEVELS: "jxplayerMediaLevels",
            jxplayer_MEDIA_LEVEL_CHANGED: "jxplayerMediaLevelChanged",
            jxplayer_CAPTIONS_CHANGED: "jxplayerCaptionsChanged",
            jxplayer_CAPTIONS_LIST: "jxplayerCaptionsList",
            jxplayer_CAPTIONS_LOADED: "jxplayerCaptionsLoaded",
            jxplayer_PLAYER_STATE: "jxplayerPlayerState",
            state: {
                BUFFERING: "BUFFERING",
                IDLE: "IDLE",
                PAUSED: "PAUSED",
            ...
            jxplayer_PLAYLIST_LOADED: "jxplayerPlaylistLoaded",
            jxplayer_PLAYLIST_ITEM: "jxplayerPlaylistItem",
            jxplayer_PLAYLIST_COMPLETE: "jxplayerPlaylistComplete",
            jxplayer_DISPLAY_CLICK: "jxplayerViewClick",
            jxplayer_CONTROLS: "jxplayerViewControls",
            jxplayer_USER_ACTION: "jxplayerUserAction",
            jxplayer_INSTREAM_CLICK: "jxplayerInstreamClicked",
            jxplayer_INSTREAM_DESTROYED: "jxplayerInstreamDestroyed",
            jxplayer_AD_TIME: "jxplayerAdTime",
            jxplayer_AD_ERROR: "jxplayerAdError",
            jxplayer_AD_CLICK: "jxplayerAdClicked",
            jxplayer_AD_COMPLETE: "jxplayerAdComplete",
            jxplayer_AD_IMPRESSION: "jxplayerAdImpression",
            jxplayer_AD_COMPANIONS: "jxplayerAdCompanions",
            jxplayer_AD_SKIPPED: "jxplayerAdSkipped"
        }
    }(jxplayer), function (e) {
        var a = e.utils;
    ...
    function (e) {
        ...
        jxplayer.parsers = {
            ...
            textContent: function (e) {
                return e ? e.textContent ? jxplayer.utils.trim(e.textContent) : e.text ? jxplayer.utils.trim(e.text) : "" : ""
            },
        ...
        function a(a) {
            ...
            return new jxplayer.playlist.item(b)
        }
        var l = jxplayer.utils,
            g = e.textContent,
            f = e.getChildNode,
            d = e.numChildren,
            c = e.localName;
            ...
            function a(c) {
                try {
                    ...
                    if ("rss" != f.localName(c)) m("Not a valid RSS feed");
                        ...
                        b.sendEvent(g.jxplayer_PLAYLIST_LOADED, {
                            playlist: n
                        })
                    }
                } catch (k) {
            ...
            m = e.embed = function (b) {
                ...
                function h() {
                    if (!E)
                        ...
                        if ("string" ==
                            ...
                            a.addEventListener(g.jxplayer_PLAYLIST_LOADED, function (a) {
                                t.playlist = a.playlist;
                                B = d;
                                h()
                            });
                            a.addEventListener(g.jxplayer_ERROR, function (a) {
                                B = d;
                                k(a)
                            });
                            B = f;
                ...
                function j(a, c) {
                    ...
                    D = setTimeout(function () {
                        D = null;
                        b.dispatchEvent(g.jxplayer_SETUP_ERROR, {
                            message: a,
                            fallback: c
                        })
                    }, 0)
        ...
        (e.embed.config = function (d) {
            var c = {
                ...
                primary: "html5",
                width: 480,
                base: d.base ? d.base : g.getScriptPath("jxplayer.js"),
                aspectratio: ""
            };
            d = g.extend(c, e.defaults, d);
            var c = {
                type: "html5",
                src: d.base + "jxplayer.html5.js"
            }, f = {
                    type: "flash",
                    src: d.base + "jxplayer.flash.swf"
                };
    ...
    function (e) {
        ...
        var l = [],
            ...
            m = e.api = function (b) {
                ...
                function h(a, b) {
                    t[a] || (t[a] = [], n(f.jxplayer_PLAYER_STATE, function (b) {
                        var c = b.newstate;
                        b = b.oldstate;
                        if (c == a) {
                            var d = t[c];
                ...
                function q(a, b) {
                    try {
                        a.jwAddEventListener(b, 'function(dat) { jxplayer("' + j.id + '").dispatchEvent("' + b + '", dat); }')
                    } catch (c) {
                ...
                j.addButton = function (a, b, c, d) {
                    try {
                        A[d] = c, k("jwDockAddButton", a, b, "jxplayer('" + j.id + "').callback('" + d + "')", d)
                    } catch (f) {
                ...
                var y = {
                    onBufferChange: f.jxplayer_MEDIA_BUFFER,
                    onBufferFull: f.jxplayer_MEDIA_BUFFER_FULL,
                    onError: f.jxplayer_ERROR,
                    onSetupError: f.jxplayer_SETUP_ERROR,
                    onFullscreen: f.jxplayer_FULLSCREEN,
                    onMeta: f.jxplayer_MEDIA_META,
                    onMute: f.jxplayer_MEDIA_MUTE,
                    onPlaylist: f.jxplayer_PLAYLIST_LOADED,
                    onPlaylistItem: f.jxplayer_PLAYLIST_ITEM,
                    onPlaylistComplete: f.jxplayer_PLAYLIST_COMPLETE,
                    onReady: f.API_READY,
                    onResize: f.jxplayer_RESIZE,
                    onComplete: f.jxplayer_MEDIA_COMPLETE,
                    onSeek: f.jxplayer_MEDIA_SEEK,
                    onTime: f.jxplayer_MEDIA_TIME,
                    onVolume: f.jxplayer_MEDIA_VOLUME,
                    onBeforePlay: f.jxplayer_MEDIA_BEFOREPLAY,
                    onBeforeComplete: f.jxplayer_MEDIA_BEFORECOMPLETE,
                    onDisplayClick: f.jxplayer_DISPLAY_CLICK,
                    onControls: f.jxplayer_CONTROLS,
                    onQualityLevels: f.jxplayer_MEDIA_LEVELS,
                    onQualityChange: f.jxplayer_MEDIA_LEVEL_CHANGED,
                    onCaptionsList: f.jxplayer_CAPTIONS_LIST,
                    onCaptionsChange: f.jxplayer_CAPTIONS_CHANGED,
                    onAdError: f.jxplayer_AD_ERROR,
                    onAdClick: f.jxplayer_AD_CLICK,
                    onAdImpression: f.jxplayer_AD_IMPRESSION,
                    onAdTime: f.jxplayer_AD_TIME,
                    onAdComplete: f.jxplayer_AD_COMPLETE,
                    onAdCompanions: f.jxplayer_AD_COMPANIONS,
                    onAdSkipped: f.jxplayer_AD_SKIPPED
                };
                    ...
                    if (c)
                        for (var c = c.slice(0), d = g.translateEventResponse(a, b), e = 0; e < c.length; e++) {
                            ...
                            if ("function" === typeof k) try {
                                a === f.jxplayer_PLAYLIST_LOADED && g.deepReplaceKeyName(d.playlist, ["__dot__", "__spc__", "__dsh__", "__default__"], [".", " ", "-", "default"]), k.call(this, d)
                            } catch (h) {
                ...
                j.playerReady = function (a) {
                    ...
                    n(f.jxplayer_PLAYLIST_ITEM, function () {
                        z = {}
                    });
                    n(f.jxplayer_MEDIA_META, function (a) {
    ...
    function (e) {
        ...
        e.api.instream = function (f, d) {
            function c(a, b) {
                h[a] || (h[a] = [], d.jwInstreamAddEventListener(a, 'function(dat) { jxplayer("' + f.id + '").dispatchInstreamEvent("' + a + '", dat); }'));
                h[a].push(b);
                return this
            }

            function e(b, d) {
                q[b] || (q[b] = [], c(a.jxplayer_PLAYER_STATE, function (a) {
                    var c = a.newstate,
                        d = a.oldstate;
                    if (c == b) {
                        var e = q[c];
            ...
            n.onError = function (b) {
                return c(a.jxplayer_ERROR, b)
            };
            n.onMediaError = function (b) {
                return c(a.jxplayer_MEDIA_ERROR, b)
            };
            n.onFullscreen = function (b) {
                return c(a.jxplayer_FULLSCREEN, b)
            };
            n.onMeta = function (b) {
                return c(a.jxplayer_MEDIA_META, b)
            };
            n.onMute = function (b) {
                return c(a.jxplayer_MEDIA_MUTE, b)
            };
            n.onComplete = function (b) {
                return c(a.jxplayer_MEDIA_COMPLETE, b)
            };
            n.onPlaylistComplete = function (b) {
                return c(a.jxplayer_PLAYLIST_COMPLETE, b)
            };
            n.onPlaylistItem = function (b) {
                return c(a.jxplayer_PLAYLIST_ITEM,
                    b)
            };
            n.onTime = function (b) {
                return c(a.jxplayer_MEDIA_TIME, b)
            };
            ...
            n.onClick = function (b) {
                return c(a.jxplayer_INSTREAM_CLICK, b)
            };
            n.onInstreamDestroyed = function (b) {
                return c(a.jxplayer_INSTREAM_DESTROYED, b)
            };
            n.onAdSkipped = function (b) {
                return c(a.jxplayer_AD_SKIPPED, b)
            };
            n.play = function (a) {
                d.jwInstreamPlay(a)
            };
...
jxplayer.key = 'uc07qtlw6msbCBwM6hoCuhgmG9FqpgOMsGqb6A==';
if (location.protocol === 'https:') {
    jxplayer.defaults = {
        flashplayer: $("#chrome_extension_id").attr('txt')+"/player/jxplayer.flash.swf",
        html5player: $("#chrome_extension_id").attr('txt')+"/player/jxplayer.html5.js",
        ph: 1
    }
} else {
    jxplayer.defaults = {
